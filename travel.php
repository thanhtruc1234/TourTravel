...
<div class="carousel-inner">
    ...
    <div class="carousel-item active">
        ...
        <div class="carousel-caption d-none d-md-block">
            <h2>Địa điểm du lịch Việt Nam</h2>
            <p>Chào mừng bạn đến thiên đường!</p>
        </div>
    </div>
...
<table style="width: 100%;">
                <tr style="width: 100%;">
                    <td style="width: 50%;">
                    <p style="color:#111;font-family: 'ZCOOL QingKe HuangYou', cursive; font-weight:500; font-size:35px; ">Bạn có thể đi đâu?</p>
                </td>
